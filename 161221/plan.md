...
TODO: уроки с http://learngitbranching.js.org/
...
Будут ещё рассказывать про `--force` - бегите.

Замечания про стиль сообщений коммитов (чтобы было остальным удобно читать): TODO
