...
"Эффект последней строки", меняли инвариант и где-то забыли, выносили константу в параметр и забыли поменять.
...
## Почему ошибки важно обнаруживать и исправлять (10 мин)
### Общие слова
...
## Типы автоматических тестов (15 минут)
### По знанию кода
...
## Что делать с зависимостями  (10 минут)
